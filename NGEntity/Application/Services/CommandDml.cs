...
{
    internal class CommandDml : ICommandDml
    {
        protected string Command { get; set; }
        protected string Table { get; set; }

        public override string ToString() => Command;
        public virtual ICommandDml SetCommand(Type connectionType) { return default; }

        protected static string GetTableName(IEntity entity)
        {
        ...
        protected static IEnumerable<PropertyInfo> GetPropertyInfo(IEntity entity)
        {
            return entity
                    .GetType()
        ...
        protected static string GetValues(IEntity entity, IEnumerable<PropertyInfo> propertyInfos)
        {
            return String.Join(',', propertyInfos.Select(s => GetValue(entity, s)));
        }
        protected static string GetValue(IEntity entity, PropertyInfo propertyInfo)
        {
